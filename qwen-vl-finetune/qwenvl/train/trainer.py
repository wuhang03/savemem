...
from qwen2_5_vl_savemem.modeling_qwen2_5_vl_savemem import (
    Qwen2_5_VisionTransformerPretrainedModel,
    Qwen2_5_VLModel,
)
...
def replace_qwen2_vl_attention_class():
    ...
    qwen2_5_vl_savemem.modeling_qwen2_5_vl_savemem._flash_attention_forward = (
        _flash_attention_forward
    )
    qwen2_5_vl_savemem.modeling_qwen2_5_vl_savemem.Qwen2_5_VLModel._update_causal_mask = (
        _update_causal_mask
    )
